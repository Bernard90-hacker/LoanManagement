        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateAjout = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "01/08/2023"),
                    DateModification = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "01/08/2023"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOperation = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "01/08/2023"),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "PROFIL-001", "01/08/2023", "01/08/2024", "", "Profil destiné à l'administrateur", "Administrateur", 1 },
                    { 2, "PROFIL-003", "01/08/2023", "01/08/2024", "", "Profil destiné aux utilisateurs", "Utilisateur", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "01/08/2023", "", true, true, true, true, 1, true },
                    { 2, "01/08/2023", "", true, false, true, true, 2, false }
                });

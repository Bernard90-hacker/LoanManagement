...
{
	public class ParamGlobalRepository : Repository<ParamGlobal>, IParamGlobalRepository
	{
        private LoanManagementDbContext _context;
        public ParamGlobalRepository(LoanManagementDbContext context) : base(context)
        {
            _context = context;
        }
